...
class Demographics(DemographicsBase):
    ...
    from an existing valid demographics.json type file or from an array of valid Nodes.
    """
    ...
    def from_params(cls,
        ...
        nodes = []
        npops = cls.get_node_pops_from_params(tot_pop, total_nodes, frac_rural)
    ...
    def from_raster_csv(cls,
        ...
        return cls.from_node_csv(grid_file_path, res, id_ref)
    ...
    def get_node_ids_from_file(cls, demographics_file):
        ...
        """
        d = cls.from_file(demographics_file)
